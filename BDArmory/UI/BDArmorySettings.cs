...
namespace BDArmory.UI
{
    ...
    public class BDArmorySettings : MonoBehaviour
    {
        ...
        [BDAPersistantSettingsField] public static float MAX_GUARD_VISUAL_RANGE = 500000;
        [BDAPersistantSettingsField] public static float MAX_ACTIVE_RADAR_RANGE = 500000;
        [BDAPersistantSettingsField] public static float MAX_ENGAGEMENT_RANGE = 500000;
